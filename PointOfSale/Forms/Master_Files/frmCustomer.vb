...
#Region "PRIVATE SUBS AND PROCS"
    ...
    Sub FillAllFields(ByVal ID As String)
        ...
        rs = Customer.GetCust(ID)

        If rs.HasRows Then
            rs.Read()
            txtCode.Text = ID
            txtFName.Text = rs!Customer_FirstName
            txtMName.Text = rs!Customer_MiddleName
            txtLName.Text = rs!Customer_LastName
            txtAdd.Text = rs!Customer_Address
            txtContNo.Text = rs!Customer_PhoneNo
            txtEmail.Text = rs!Customer_Email
            txtPhoneNo.Text = rs!Customer_PhoneNo
...
#Region "BUTTONS"
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        Customer.DeleteCust(txtCode.Text)

        MsgBox("Successfully deleted transaction " & Trim(txtCode.Text) & ".", MsgBoxStyle.Information + MsgBoxStyle.OkOnly, "INFORMATION")
        mf.ClearAllFields(pnlMain)
        ToggleLock(True)
    End Sub
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If Trim(txtFName.Text) = "" Or
           Trim(txtMName.Text) = "" Or
           Trim(txtAdd.Text) = "" Or
           Trim(txtContNo.Text) = "" Then
            MsgBox("Please provide a valid justification.", MsgBoxStyle.Exclamation + MsgBoxStyle.OkOnly, "VALIDATION")
            Exit Sub
        End If

        'CONFIRM BEFORE SAVING
        If MsgBox("Are you sure you want to save?", MsgBoxStyle.YesNo + MsgBoxStyle.Question, "CONFIRMATION") = MsgBoxResult.No Then
            Exit Sub
        End If
        ...
        Select Case strAddmode
            Case AddMode.Add
                ...
                'SAVE PRODUCTS
                Customer.SaveCust(txtCode.Text, txtFName.Text, txtMName.Text, txtLName.Text, txtEmail.Text, txtContNo.Text, txtPhoneNo.Text, txtAdd.Text)
        ...
        MsgBox("Customer " & txtFName.Text & " has been saved successfully!", MsgBoxStyle.Information + MsgBoxStyle.OkOnly, "INFORMATION")
